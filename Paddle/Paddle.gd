...
func hit(_ball):
	...
	$Tween.interpolate_property($Images/Highlight, "scale", Vector2(0.3, 0.3), Vector2(1.0, 1.0), time_highlight_size, Tween.TRANS_BOUNCE, Tween.EASE_IN)
	$Tween.start()
